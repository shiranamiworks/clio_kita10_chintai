  ...
  <section id="contentsWrap"> 
    ...
    <section class="foot-caption inner">
      <p>
        ...
        <br>※掲載の外観完成予想図は、設計段階の図を基に描き起こしたもので、形状・等は実際とは異なる場合があります。形状の細部、設備機器等は表現していません。表現されている植栽は設計段階のものであり、変更になる場合があります。また葉の合いや枝ぶりや樹形は想定であり、竣から育期間を経た状態のものを描いています。また特定の季節状態をすものではありません。敷地周辺の建物などについては省略しています。
        ...
        <br>※掲載の航空写真は現地周辺を撮影（2021年10月）した写真をCG加工したもので実際とは異なります。また現地の位置を表現した光は、建物の規模や高さを示すものではございません。周辺環境は将来にわたり保証されるものではございません。
        <br>※表示の徒歩分数は1分＝80mで計算した概算であり、端数は切り上げています。
        <br>※掲載物件は、掲載中に成約済、募集中止、あるいは賃料変更となる場合がございます。
      </p>
    </section>
  </section>
